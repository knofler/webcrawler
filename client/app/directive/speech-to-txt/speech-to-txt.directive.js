...
angular.module('webcrawler')
  .directive('speechToTxt', function () {
    return {
      templateUrl: 'app/directive/speech-to-txt/speech-to-txt.html',
      restrict: 'EA',
      link: function (scope, element, attrs) {
			...
			recognition.onstart 	= function () {
			   ...
			   start_img.src = 'assets/images/speech/mic-animate.gif';
			 };
			recognition.onerror 	= function (event) {
				if (event.error == 'no-speech') {
				  start_img.src = 'assets/images/speech/mic.gif';
			...
			scope.startButton 		= function (event) {	
			  ...
			  start_img.src = 'assets/images/speech/mic-slash.gif';
